...
class BlogCategoryDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('name')->title('Tên danh mục')->addClass('align-middle'),
            Column::make('slug')->title('Slug')->addClass('align-middle'),
            Column::make('status')->title('Trạng thái')->addClass('align-middle'),
