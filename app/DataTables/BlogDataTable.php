...
class BlogDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('title')->title('Tiêu đề')->addClass('align-middle'),
            Column::make('category')->title('Danh mục')->addClass('align-middle'),
            Column::make('publish_date')->title('Ngày đăng')->addClass('align-middle'),
