...
class UserOrderDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $viewBtn = "<a href='".route('user.orders.show', $query->id)."' class='status-btn ' ><i class='far fa-eye icon-size'></i></a>";
                return $viewBtn;
            })
    ...
    {
        return $model::where('user_id',Auth::guard('customer')->user()->id)->newQuery();
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('user_id')->title('Thông tin đặt hàng')->addClass('align-middle'),
