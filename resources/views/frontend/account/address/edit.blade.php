                                ...
                                <div class="row">
                                  <div class="col-xl-6 col-md-6">
                                    <div class="wsus__add_address_single">
                                      ...
                                      <input type="text" placeholder="Họ và Tên người nhận" value="{{ $address->name }}" name="name">
                                    </div>
                                  </div>
                                  <div class="col-xl-6 col-md-6">
                                    <div class="wsus__add_address_single">
                                      <label>Số điện thoại<b>*</b></label>
                                      <input type="text" placeholder="Số điện thoại người nhận" value="{{ $address->phone }}" name="phone">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-xl-12">
                                    <div class="wsus__add_address_single">
                                      ...
                                      <textarea cols="3" rows="2" placeholder="Nhập địa chỉ cụ thể" name="address">{{ $address->address }}</textarea>
                                    </div>
                                  </div>
                                  <div class="col-xl-6">
