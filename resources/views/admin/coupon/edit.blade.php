...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('admin.slider.index') }}">Mã Giảm Giá</a></div>
                ...
                <form action="{{ route('admin.coupon.update', $coupon->id) }}"  method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="type" id="inputState" class="form-control">
                                <option {{ $coupon->type == 1 ? 'selected' : '' }} value="1">Giảm theo tiền</option>
                            <option {{ $coupon->type == 0 ? 'selected' : '' }} value="0">Giảm theo phần trăm</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-3">
                            <label for="">Số lượng mã<span class="text-danger">(*)</span></label>
                        ...
                        <div class="form-group col-3">
                            ...
                            <input type="number" class="form-control" name="min_price" value="{{ $coupon->min_price }}">
                        </div>
                        <div class="form-group col-3">
                            <label for="">Đơn tối hiểu</label>
                            <input type="number" class="form-control" name="min_order" value="{{ $coupon->min_order }}">
                        </div>
                        <div class="form-group col-3">
                            <label for="">Giảm tối đa</label>
                            <input type="number" class="form-control" name="max_price" value="{{ $coupon->max_price }}">
                        </div>
                    </div>
